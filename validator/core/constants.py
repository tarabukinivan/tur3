...
# DPO synthetic data constants
DPO_SYNTHETIC_TOTAL_SIZE = 1000
DPO_SYNTHETIC_FOR_TRAINING = 500
DPO_SYNTHETIC_FOR_EVAL = 500
DPO_SYNTH_EXAMPLES_FROM_TRAIN = 500
...
PERCENTAGE_REWARD_FUNCTIONS_GENERIC_FROM_LLM = 0.5
...
# scoring stuff
INSTRUCT_TEXT_TASK_SCORE_WEIGHT = 0.2
IMAGE_TASK_SCORE_WEIGHT = 0.325
DPO_TASK_SCORE_WEIGHT = 0.225
